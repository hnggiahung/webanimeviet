...
// ====== BANNER TĨNH (HARDCODED - KHÔNG DÙNG API) ======
// Banner được cố định trong HTML + CSS, dùng ảnh banner.jpg
// Không cần JS can thiệp. Thay file banner.jpg là đổi banner.
function initBanner() {
    // ĐÃ VÔ HIỆU - Banner tĩnh dùng ảnh banner.jpg, không cần JS
}
...
// ============================================================
// BANNER SIDEBAR (ĐÃ VÔ HIỆU - Banner tĩnh không dùng sidebar)
// ============================================================
// Sidebar banner đã bị xóa khỏi HTML, thay bằng banner tĩnh
